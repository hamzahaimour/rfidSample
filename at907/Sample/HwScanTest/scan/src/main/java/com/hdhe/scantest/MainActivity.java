...
//                String barcode = Tools.Bytes2HexString(data, data.length);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn = (Button) checkBoxAuto.findViewById(R.id.button_test);
        btnClear = (Button) checkBoxAuto.findViewById(R.id.button_clear);
        lv = (ListView) checkBoxAuto.findViewById(R.id.listview_barcode);
        mTvTipsDate = checkBoxAuto.findViewById(R.id.tips_date);
        mTvTipsBattery = checkBoxAuto.findViewById(R.id.tips_battery);
        checkBoxAuto = checkBoxAuto.findViewById(R.id.checkbox_auto);
        context = this;
