...
public class TagListAdapter extends BaseAdapter {
    ...
    // export to txt/csv : adding additional APIs
    public float getRssi(int position) {
        return mList.get(position).getRssi();
    }

    public float getPhase(int position) {
        return mList.get(position).getPhase();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            convertView = mInflater.inflate(null, parent,
                    false);
    ...
    private class TagListViewHolder {
        ...
        public TagListViewHolder(View parent) {
            txtTag = (TextView) parent.findViewById(1);
            txtRssi = (TextView) parent.findViewById(1);
            txtPhase = (TextView) parent.findViewById(1);
            txtCount = (TextView) parent.findViewById(1);
            parent.setTag(this);
            isVisibleRssi = false;
        }
